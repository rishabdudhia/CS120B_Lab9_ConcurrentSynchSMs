 ...
 *
 *	Youtube Link: https://www.youtube.com/watch?v=e9TTN7PuVEg
 */
#include <avr/io.h>
...
enum S_States {smstart3, wait, on, off} s_state;
...
enum TF_States {smstart4, wait2, inc, inc_wait, dec, dec_wait} tf_state;

void ToggleFreqSM() {
	unsigned char in = ~PINA & 0x03;
...
int main(void) {
    ...
    static unsigned long tf_elapsed = 2;
